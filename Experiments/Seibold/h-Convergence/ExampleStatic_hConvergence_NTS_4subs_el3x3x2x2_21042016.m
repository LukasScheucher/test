...
p.sizes = [3 3 3 3;    % size of subsstructures in meters from first substructure to last; first line = length, second line = height
            1 1 1 1];
p.elcount = [3 3 2 2]; % element count in y-direction for each substructure from first to last
